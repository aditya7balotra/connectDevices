...
class share_all_photos:
    '''
    this class does the work of sharing all the photos from one device to another
    '''
    ...
    def receive(self):
        ...
        while True:
            ...
            content = self.client_socket.recv(chunk_size + 100)
            if len(content) > 0:
